      ...
      <Card>
        <CardContent className="p-5 flex items-center justify-between">
          <div className="space-y-1 min-w-0">
            ...
            <p className="text-2xl font-bold tracking-tight tabular-nums truncate">{total}</p>
            <p className="text-xs text-muted-foreground truncate">Tersimpan di Brankas</p>
          </div>
      ...
      <Card className={expiringSoon > 0 ? "border-amber-500/30 bg-amber-500/5" : ""}>
        <CardContent className="p-5 flex items-center justify-between">
          <div className="space-y-1 min-w-0">
            ...
            <p className="text-2xl font-bold tracking-tight tabular-nums truncate text-amber-600 dark:text-amber-400">
              {expiringSoon}
            </p>
            <p className="text-xs text-muted-foreground truncate">&le; 30 Hari ke Depan</p>
          </div>
      ...
      <Card className={expired > 0 ? "border-destructive/30 bg-destructive/5" : ""}>
        <CardContent className="p-5 flex items-center justify-between">
          <div className="space-y-1 min-w-0">
            ...
            <p className="text-2xl font-bold tracking-tight tabular-nums truncate text-destructive">{expired}</p>
            <p className="text-xs text-muted-foreground truncate">Perlu Tindakan Segera</p>
          </div>
      ...
      <Card>
        <CardContent className="p-5 flex items-center justify-between">
          <div className="space-y-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground truncate">SHM, Akta, Ijazah</p>
          </div>
